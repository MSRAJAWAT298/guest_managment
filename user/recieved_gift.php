...
if (isset($_POST['submit'])) {
    ...
    //echo 'window.location.href="http://localhost/event_managment/admin/view_recived_gift.php";';
    echo '</script>';
		}
    }
}
...
if (isset($_POST['update'])) {
  ...
  $array = array(
    ...
    echo 'window.location.href="http://localhost/event_managment/admin/view_recieve_gifts.php";';
    echo '</script>';
...
<?php include 'include/sidebar.php';?>
 <div class="col main pt-5 mt-3">
				...
				<?php if (!empty($_GET['edit_id'])){echo "Edit Recived Gift";}else{ echo "Add Recived Gift";}?></h1>
				...
				<div class="col-lg-2 ml-auto">
					<a class="nav-link btn btn-outline-light bg-info  border"
						href="view_recieve_gifts.php">View Recived Gift</a>
				</div>
				<form class="font-weight-bold" method="POST" id="myForm" action="" autocomplete="on" enctype="multipart/form-data">
					...
					<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="gift_rupees">Gift Rupees:</label> 
								<input type="number" 
									   class="form-control rounded" 
									   id="gift_rupees" 
								...
								<span class="text-danger" id="error_rupees"></span>
							</div>
						</div>
...
// 		  alert("helo");
		...
		if(!$('#mob').val().match('[0-9]{10}'))  {
			  $("#error_mob").text("Please put 10 digit mobile numberr ");
			  flag=false;  
		  }else{
			  $("#error_mob").text("");}
